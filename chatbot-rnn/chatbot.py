...
def sample_main(args):
    ...
    with tf.Session(config=config) as sess:
        ...
        chatbot(net, sess, chars, vocab, args.n, args.beam_width, args.relevance, args.temperature, args.port)
...
def chatbot(net, sess, chars, vocab, max_length, beam_width, relevance, temperature, port):
    ...
    while True:
        ...
        user_input = sanitize_text(vocab, input_text)
